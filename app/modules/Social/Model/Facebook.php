...
//        }
    ...
    public function getPost($post_id) {
        ...
        $cache = Zend_Registry::get('cache');
//        if(($post = $cache->load('SOCIAL_FACEBOOK_'.sha1($post_id))) === false) {
            $this->_page = 1;
...
//        }
    ...
    protected function _getFBPosts($username){
        ...
        $url = "https://graph.facebook.com/$username/?fields=posts,picture&access_token=$access_token";//feeds.fields(message,name,caption,story,comments.fields(id,message,from,created_time),likes.fields(name),type,from,picture),
//        Zend_Debug::dump($url);
//        Die;
