...
//            alert("Sorry but we can't go any further (for the time being)");
//            alert("Come back soon, bitch!");
//            return this;
//        }

        if(this.steps[this.current_step_id]) {
            if(!this.steps[this.current_step_id].canGoForward()) return this;
    ...
    previousStep: function() {
        ...
        if(!this.steps[this.current_step_id-1]) return this;
...
//            }
    ...
    installPlugin: function(key) {
        ...
        if(key >= Object.getSize(this.plugins)) {
        ...
        $.ajax({
            ...
            success: function(datas) {
                if(datas.success) {
                    var width = (key+1) * 100 / Object.getSize(this.plugins);
    ...
    hide: function(dir) {
        ...
        if(dir == 'next') {
            ...
            setTimeout(function() {
                ...
                setTimeout(function() {$('.steps_content .step'+this.id).hide();}.bind(this), 650);
            }.bind(this), 200);
