...
class OLE extends PEAR
{
    ...
    */
     ...
     * @access private
     */
    protected function _getBlockOffset($blockId)
    {
     ...
     * @access private
     */
    protected function _readInt1($fh)
    {
     ...
     * @access private
     */
    protected function _readInt2($fh)
    {
     ...
     * @access private
     */
    protected function _readInt4($fh)
    {
    ...
    * @return mixed true on success, PEAR_Error on failure
    */
    protected function _readPpsWks($blockId)
    {
    ...
    */
    protected function _ppsTreeComplete($index)
    {
